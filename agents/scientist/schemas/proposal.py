...
class ProposalSource(str, Enum):
    ...
    #: The pre-committed human-authored baseline arm (`extension_1`; see scripts/run_extension_1.py).
    #: Like EXHAUSTIVE_CANONICAL it is NOT generated by the procedure under test, so
    #: labelling it with a ladder rung would be false provenance. No code path branches on this
    #: enum's value, and it never enters a proposal family.
    PRE_COMMITTED_HUMAN = "pre_committed_human"
